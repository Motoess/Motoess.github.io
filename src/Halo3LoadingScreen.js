...
function main () {
    ...
    var loading_div = document.getElementById("status-container");
	// Set Time Start
	...
	function fade_to_canvas() {
	   if (canvas_opacity < 1) {
          ...
          loading_div.style.opacity = canvas_opacity; // apply the same opacity to the text div
